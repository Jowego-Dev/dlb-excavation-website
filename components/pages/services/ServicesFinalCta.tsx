        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-white/85 sm:text-lg">
              Tell us about your lot, your deadline, and the finish you are
              aiming for. We will map the right equipment, haul strategy, and
              crew size to get it done without drama.
            </p>
          </div>
